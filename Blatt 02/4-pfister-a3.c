...
//  Copyright © 2016 Clemens Pfister.
//
/*
   Deﬁnieren Sie eine Variable vom Typ Integer namens n.
   Weisen Sie dieser Variable einen Wert zu und geben
   Sie alle Zahlen von 1 bis n aus welche ohne Rest
   durch dreizehn teilbar sind.
*/
